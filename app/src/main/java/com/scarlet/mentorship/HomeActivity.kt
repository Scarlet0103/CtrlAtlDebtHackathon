...
import com.scarlet.mentorship.util.TopMentorsClickListner
...
class HomeActivity : AppCompatActivity(), TopMentorsClickListner {
    ...
    private fun getData(){
        mentorsList.add(Mentor("IU","X Maths Mentor","110 Followers",R.drawable.profile4))
        mentorsList.add(Mentor("Mina","X Physics Mentor","196 Followers",R.drawable.profile5))
        mentorsList.add(Mentor("Zendya","XI Maths Mentor","95 Followers",R.drawable.profile6))
        mentorsList.add(Mentor("Samuel","IX Social Mentor","204 Followers",R.drawable.profile1))
        mentorsList.add(Mentor("Nancy","IIX English Mentor","196 Followers",R.drawable.profile2))
        mentorsList.add(Mentor("Selena","IX Biology Mentor","135 Followers",R.drawable.profile3))
    ...
    override fun onRecyclerViewItemClick(position : Int) {
        ...
        bottomSheetDialog.findViewById<TextView>(R.id.companyBottom)?.text = mentorsList[position].standardExp
